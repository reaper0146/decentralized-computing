...
class RunCommandAllOf(object):
    ...
    def __init__(self, run=None, local_vars_configuration=None):  # noqa: E501
        """RunCommandAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def run(self):
        """Gets the run of this RunCommandAllOf.  # noqa: E501


        :return: The run of this RunCommandAllOf.  # noqa: E501
        :rtype: RunCommandBody
        """
        return self._run

    @run.setter
    def run(self, run):
        """Sets the run of this RunCommandAllOf.


        :param run: The run of this RunCommandAllOf.  # noqa: E501
        :type: RunCommandBody
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunCommandAllOf):
            return False

...
class DeployCommandAllOf(object):
    ...
    def __init__(self, deploy=None, local_vars_configuration=None):  # noqa: E501
        """DeployCommandAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def deploy(self):
        """Gets the deploy of this DeployCommandAllOf.  # noqa: E501


        :return: The deploy of this DeployCommandAllOf.  # noqa: E501
        :rtype: object
        """
        return self._deploy
    ...
    def deploy(self, deploy):
        """Sets the deploy of this DeployCommandAllOf.


        :param deploy: The deploy of this DeployCommandAllOf.  # noqa: E501
        :type: object
        """
        if self.local_vars_configuration.client_side_validation and deploy is None:  # noqa: E501
            raise ValueError("Invalid value for `deploy`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployCommandAllOf):
            return False

...
import ya_activity
from ya_activity.models.runtime_event_kind_finished_body import RuntimeEventKindFinishedBody  # noqa: E501
from ya_activity.rest import ApiException

class TestRuntimeEventKindFinishedBody(unittest.TestCase):
    """RuntimeEventKindFinishedBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test RuntimeEventKindFinishedBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ya_activity.models.runtime_event_kind_finished_body.RuntimeEventKindFinishedBody()  # noqa: E501
        if include_optional :
            return RuntimeEventKindFinishedBody(
                return_code = 56, 
                message = '0'
            )
        else :
    ...
    def testRuntimeEventKindFinishedBody(self):
        """Test RuntimeEventKindFinishedBody"""

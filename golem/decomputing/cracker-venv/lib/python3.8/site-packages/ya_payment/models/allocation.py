...
class Allocation(object):
    ...
    def __init__(self, allocation_id=None, timestamp=None, address=None, payment_platform=None, total_amount=None, spent_amount=None, remaining_amount=None, timeout=None, make_deposit=None, local_vars_configuration=None):  # noqa: E501

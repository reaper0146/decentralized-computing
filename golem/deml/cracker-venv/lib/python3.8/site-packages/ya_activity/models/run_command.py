...
class RunCommand(object):
    ...
    def __init__(self, run=None, local_vars_configuration=None):  # noqa: E501
        """RunCommand - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def run(self):
        """Gets the run of this RunCommand.  # noqa: E501


        :return: The run of this RunCommand.  # noqa: E501
    ...
    @run.setter
    def run(self, run):
        """Sets the run of this RunCommand.


        :param run: The run of this RunCommand.  # noqa: E501
        :type: RunCommandBody
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunCommand):
            return False

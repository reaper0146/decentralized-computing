...
class StartCommandAllOf(object):
    ...
    def __init__(self, start=None, local_vars_configuration=None):  # noqa: E501
        """StartCommandAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def start(self):
        """Gets the start of this StartCommandAllOf.  # noqa: E501


        :return: The start of this StartCommandAllOf.  # noqa: E501
        :rtype: StartCommandBody
        """
        return self._start

    @start.setter
    def start(self, start):
        """Sets the start of this StartCommandAllOf.


        :param start: The start of this StartCommandAllOf.  # noqa: E501
        :type: StartCommandBody
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StartCommandAllOf):
            return False

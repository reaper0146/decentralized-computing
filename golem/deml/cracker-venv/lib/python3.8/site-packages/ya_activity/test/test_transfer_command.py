...
import ya_activity
from ya_activity.models.transfer_command import TransferCommand  # noqa: E501
from ya_activity.rest import ApiException

class TestTransferCommand(unittest.TestCase):
    """TransferCommand unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TransferCommand
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ya_activity.models.transfer_command.TransferCommand()  # noqa: E501
        if include_optional :

...
import ya_activity
from ya_activity.models.start_command_all_of import StartCommandAllOf  # noqa: E501
from ya_activity.rest import ApiException

class TestStartCommandAllOf(unittest.TestCase):
    """StartCommandAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StartCommandAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ya_activity.models.start_command_all_of.StartCommandAllOf()  # noqa: E501
        if include_optional :
            return StartCommandAllOf(
                start = ya_activity.models.start_command_body.StartCommandBody(
                    args = [
                        '0'
                        ], )
            )
    ...
    def testStartCommandAllOf(self):
        """Test StartCommandAllOf"""

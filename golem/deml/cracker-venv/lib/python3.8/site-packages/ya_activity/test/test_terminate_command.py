...
import ya_activity
from ya_activity.models.terminate_command import TerminateCommand  # noqa: E501
from ya_activity.rest import ApiException

class TestTerminateCommand(unittest.TestCase):
    """TerminateCommand unit test stubs"""

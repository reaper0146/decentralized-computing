...
import ya_activity
from ya_activity.models.run_command_all_of import RunCommandAllOf  # noqa: E501
from ya_activity.rest import ApiException

class TestRunCommandAllOf(unittest.TestCase):
    """RunCommandAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test RunCommandAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ya_activity.models.run_command_all_of.RunCommandAllOf()  # noqa: E501
        if include_optional :
            return RunCommandAllOf(
                run = ya_activity.models.run_command_body.RunCommandBody(
                    entry_point = '0', 
                    args = [
                        '0'
                        ], )

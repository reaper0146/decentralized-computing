...
import ya_activity
from ya_activity.models.run_command_body import RunCommandBody  # noqa: E501
from ya_activity.rest import ApiException

class TestRunCommandBody(unittest.TestCase):
    """RunCommandBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = ya_activity.models.run_command_body.RunCommandBody()  # noqa: E501
        if include_optional :
            return RunCommandBody(
                entry_point = '0', 
                args = [
                    '0'
                    ]

...
import ya_activity
from ya_activity.models.transfer_command_body import TransferCommandBody  # noqa: E501
from ya_activity.rest import ApiException

class TestTransferCommandBody(unittest.TestCase):
    """TransferCommandBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TransferCommandBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ya_activity.models.transfer_command_body.TransferCommandBody()  # noqa: E501
        if include_optional :
            return TransferCommandBody(
                _from = '0', 
                to = '0', 
                format = '0', 
                depth = 1.337, 
                fileset = [
                    ya_activity.models.file_set.FileSet(
                        desc = '0', 
                        includes = [
                            '0'
                            ], 
    ...
    def testTransferCommandBody(self):
        """Test TransferCommandBody"""

...
const getChainDefaults = ({
  ...
  ipfsGateway: ipfsGatewayMap[flavour] && (ipfsGatewayMap[flavour][id] || ipfsGatewayMap[flavour].default) || 'https://ipfs.iex.ec',
  iexecGateway: iexecGatewayMap[flavour] && (iexecGatewayMap[flavour][id] || iexecGatewayMap[flavour].default) || 'https://v6.api.market.iex.ec',
